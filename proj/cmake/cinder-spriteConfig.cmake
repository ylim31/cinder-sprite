if(NOT TARGET cinder-sprite)
    # Define ${Cinder-Notifications_PROJECT_ROOT}. ${CMAKE_CURRENT_LIST_DIR} is just the current directory.
    get_filename_component(cinder-sprite_PROJECT_ROOT "${CMAKE_CURRENT_LIST_DIR}/../.." ABSOLUTE)

    # Define ${CINDER_PATH} as usual.
    get_filename_component(CINDER_PATH "${cinder-sprite_PROJECT_ROOT}/../.." ABSOLUTE)
    ...
    # Create the library!
    add_library(cinder-sprite ${SOURCE_LIST})

    # Add include directories.
    # Notice that `cinderblock.xml` has `<includePath>src</includePath>`.
    # So you need to set `../../src/` to include.
    target_include_directories(cinder-sprite PUBLIC "${cinder-sprite_PROJECT_ROOT}/src" )
    target_include_directories(cinder-sprite SYSTEM BEFORE PUBLIC "${CINDER_PATH}/include" )
    ...
    target_link_libraries(cinder-sprite PRIVATE cinder)
